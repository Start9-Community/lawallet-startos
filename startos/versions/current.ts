...
export const current = VersionInfo.of({
  version: '2.7.0:1',
  releaseNotes: {
    en_US: `Updates LaWallet NWC from 2.0.0 to 2.7.0.
...
Full release notes: ${CHANGELOG}`,
    es_ES: `Actualiza LaWallet NWC de 2.0.0 a 2.7.0.
...
Notas de la versión completas: ${CHANGELOG}`,
    de_DE: `Aktualisiert LaWallet NWC von 2.0.0 auf 2.7.0.
...
Vollständige Versionshinweise: ${CHANGELOG}`,
    pl_PL: `Aktualizuje LaWallet NWC z 2.0.0 do 2.7.0.
...
Pełne informacje o wydaniach: ${CHANGELOG}`,
    fr_FR: `Met à jour LaWallet NWC de 2.0.0 vers 2.7.0.
